...
public:
    ...
    private:
        ...
        std::vector<unsigned long> _str_param_len{};
        std::vector<my_bool> _param_is_null{};
        std::vector<std::uint32_t> _uint_param_storage{};
        std::vector<int> _int_param_storage{};
        std::vector<long long> _bigint_param_storage{};
        std::vector<double> _double_param_storage{};

        // results
        std::vector<MYSQL_BIND> _results{};
        std::vector<std::unique_ptr<char[]>> _str_result_storage{};
        std::vector<unsigned long> _str_result_len{};
        std::vector<my_bool> _result_is_null{};
        std::vector<unsigned> _uint_result_storage{};
        std::vector<std::int64_t> _bigint_result_storage{};
        std::vector<double> _double_result_storage{};
        std::vector<int> _int_result_storage{};
        enum class _ColKind
        {
            STR,
            UINT,
